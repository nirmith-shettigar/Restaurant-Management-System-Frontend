<template>
  ...
  >
    ...
    >
      ...
      <div class="px-6 pb-5 bg-gray-50 border-gray-200 flex gap-3">
        <button
          @click="closeModal"
        ...
        <button
          @click="confirmCancel"
          class="flex-1 px-4 py-2.5 bg-red-600 text-white rounded-lg hover:bg-red-700 transition font-medium cursor-pointer"
        >
          Yes, Cancel Booking
        </button>
      </div>
