<template>
  <div class="max-w-11/12 mx-auto p-6 font-sans">
    ...
    <div class="mb-24">
      ...
      <div
        v-if="!selectedTable"
        class="text-center py-12 text-gray-400 bg-gray-50 rounded-xl italic"
      >
      ...
      <div v-else class="space-y-4">
        ...
        >
          ...
          <div class="flex flex-col items-center gap-2 md:flex-row md:gap-3">
            ...
            <span
              class="text-lg font-medium text-gray-700 text-center order-2 md:order-2"
            >
              {{ getQuantity(item.id) }}
            </span>
            <button
